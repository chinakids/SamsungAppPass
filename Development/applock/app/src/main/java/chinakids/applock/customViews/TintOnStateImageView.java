package chinakids.applock.customViews;
...
public class TintOnStateImageView extends ImageView
{
    ...
    {
        TypedArray a = context.obtainStyledAttributes(attributeSet, chinakids.applock.R.styleable.TintOnStateImageView, defStyle, 0);
        mColorStateList = a.getColorStateList(chinakids.applock.R.styleable.TintOnStateImageView_colorStateList);
        a.recycle();
    }
    ...
    private void updateTintColor()
    {
        int color = mColorStateList.getColorForState(getDrawableState(),
                getResources().getColor(chinakids.applock.R.color.nav_drawer_item_icon_normal));
